...
const LevelScript level_hmc_entry[] = {
	...
	AREA(1, hmc_area_1),
		...
		OBJECT(E_MODEL_BIRDS2, -8414, -4913, -695, 0, -180, 0, (9 << 24), bhvRedBird),
		OBJECT(E_MODEL_BIRDS2, -6598, -5534, -533, 0, -180, 0, (9 << 24), bhvRedBird),
		OBJECT(E_MODEL_BIRDS2, -8320, -6104, -2409, 0, -180, 0, (9 << 24), bhvRedBird),
		OBJECT(E_MODEL_BIRDS2, -6659, -6001, -2026, 0, -180, 0, (9 << 24), bhvRedBird),
		OBJECT(E_MODEL_BIRDS2, -6742, -6092, -2807, 0, -180, 0, (9 << 24), bhvRedBird),
		OBJECT(E_MODEL_BIRDS2, -8147, -6715, -4164, 0, -180, 0, (9 << 24), bhvRedBird),
		OBJECT(E_MODEL_BIRDS2, -8223, -6253, -3441, 0, -180, 0, (9 << 24), bhvRedBird),
		OBJECT(E_MODEL_BIRDS2, -7228, -6715, -3601, 0, -180, 0, (9 << 24), bhvRedBird),
